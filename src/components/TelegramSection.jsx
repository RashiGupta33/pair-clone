...
export default function TelegramSection() {
    return (
        <section
            ...
            style={{
                background:
                    "linear-gradient(180deg,#c8b8ff 0%,#8c6ef8 24%,#5b36e8 58%,#241041 100%)",
            }}
        >
            {/* Bottom Glow */}
            ...
            <div className="relative z-10 mx-auto max-w-7xl px-6">
                <div className="flex flex-col items-center">
                    {/* Badge */}
                    <div className="mb-8 rounded-full border border-white/20 bg-[#180C38]/80 px-6 py-2 backdrop-blur">
                    ...
                    {/* Heading */}
                    <h2 className="max-w-6xl text-center text-5xl font-bold leading-none text-white md:text-7xl xl:text-[140px]">
                        30 Employees
                        <br />
                        $30b Valuation
                    </h2>
